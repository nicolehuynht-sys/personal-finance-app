    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-premium-bg px-6">
        <div className="w-full max-w-sm text-center">
          ...
          <Link href="/auth/login" className="inline-block mt-6 text-deep-green font-semibold text-sm hover:underline">
            Back to login
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-premium-bg px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-silver-metallic mt-1">Start tracking your finances</p>
        </div>
        ...
        <p className="text-center text-sm text-silver-metallic mt-6">
          ...
          <Link href="/auth/login" className="text-deep-green font-semibold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
